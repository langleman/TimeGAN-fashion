...
for cat in category:
    ...
    # %%
    df = pd.read_csv(f'/home/langleman/TimeGAN4paper/generated_data/data/generated_data_new_{cat}.csv')
    df.shape
    ...
    df.to_csv(os.path.join(folder_path, f'padded_weekly_{cat}.csv'), index=False)
    ...
    save_path = f'/home/langleman/TimeGAN4paper/generated_data/plot4all/{cat}_plot.png'
